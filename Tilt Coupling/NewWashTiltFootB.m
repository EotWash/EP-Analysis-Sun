...
if (true)
    ...
    inAGI = tdmsread(['G:\Shared drives\Eot-Wash\NewWash\Data\' run '.tdms'], ChannelGroup="raw_data", ChannelNames="AGI2");
    inAGI2 = tdmsread(['G:\Shared drives\Eot-Wash\NewWash\Data\' run '.tdms'], ChannelGroup="raw_data", ChannelNames="AGI1");
...
text(1.5e-4,8e-14,['Tilt Coupling: ' num2str(abs(mu)/kappa*100,2) ' +- ' num2str(un/kappa*100,1) ' %'],'FontSize',16,'Interpreter', 'latex')
legend('Data', 'AGI 1', 'TT Frequency','Resonance','Thermal','Interpreter', 'latex')
title('Tilt Injection Foot B','Interpreter', 'latex')
set(gca,'FontSize',16);
set(l,'LineWidth',1.5);
ylim([1e-19 1e-12])
xlim([1e-5 1e-1])
...
if (true)
    ...
    print(fig2,'EP_TiltInjFootB.pdf','-dpdf','-r1200')
